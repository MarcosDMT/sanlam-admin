...
export default async function handler(req, res) {
    if (req.method === API_METHODS.GET) {
        try {
            ...
            await backendAxiosInstance.get(API_URL.GET_CUSTOMERS, config).then(response => {
        ...
        try {
            ...
            await backendAxiosInstance.get(`${API_URL.GET_CUSTOMER_APPLICATIONS}/${body.customerId}/applications`, config).then(response => {
                res.status(200).json(response.data);
